...
import color.kidpaint.com.kidpaintcolor.widget.button.ToolsAdapter;
...
public class ToolsDialog extends BaseDialog implements OnItemClickListener,
	...
	private ColorActivity mParent;

	private ToolsDialog(Context context) {
		super(context);
		mParent = (ColorActivity) context;
		mToolButtonAdapter = new ToolsAdapter(context,
				AnimalsColoringApplication.openedFromCatroid);
	}
	...
	public static void init(ColorActivity mainActivity) {
