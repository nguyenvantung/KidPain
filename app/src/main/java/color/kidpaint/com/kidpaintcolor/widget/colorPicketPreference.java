 ...
 */
public class colorPicketPreference extends Preference {
    private final boolean supportsAlpha;
    int value;

    public colorPicketPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setWidgetLayoutResource(R.layout.color_picket_pref_widget);
    }
    ...
    @Override protected void onClick() {
        new ColorPicketDialog(getContext(), value, supportsAlpha, new ColorPicketDialog.OnAmbilWarnaListener() {
            @Override public void onOk(ColorPicketDialog dialog, int color) {
            ...
            @Override public void onCancel(ColorPicketDialog dialog) {
                // nothing to do
            }
        }).show();
    }
