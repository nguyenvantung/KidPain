...
import color.kidpaint.com.kidpaintcolor.tools.helper.FillAlgorithm;
...
public class FillCommand extends BaseCommand {
	...
	public void run(Canvas canvas, Bitmap bitmap) {
		...
		if (AnimalsColoringApplication.savedPictureUri == null
				&& AnimalsColoringApplication.commandManager.getNumberOfCommands() == EMPTY_COMMAND_LIST_LENGTH + 1) {
