...
import color.kidpaint.com.kidpaintcolor.command.implementation.PathCommand;
import color.kidpaint.com.kidpaintcolor.command.implementation.PointCommand;
...
public class CursorTool extends BaseToolWithShape {
	...
	public CursorTool(Context context, ToolType toolType) {
		...
		mPrimaryShapeColor = AnimalsColoringApplication.applicationContext
	...
	public boolean handleMove(PointF coordinate) {
		...
		PointF cursorSurfacePosition = AnimalsColoringApplication.perspective
				.getSurfacePointFromCanvasPoint(new PointF(newCursorPositionX,
						newCursorPositionY));

		float surfaceWidth = AnimalsColoringApplication.drawingSurface.getWidth();
		float surfaceHeight = AnimalsColoringApplication.drawingSurface.getHeight();
		...
		if (slowCursor) {
			PointF cursorCanvasPosition = AnimalsColoringApplication.perspective
	...
	protected boolean addPathCommand(PointF coordinate) {
		...
		return AnimalsColoringApplication.commandManager.commitCommand(command);
	}
