 ...
 */
public class ColorPicketSquare extends View {
    Paint paint;
    Shader luar;
    final float[] color = { 1.f, 1.f, 1.f };

    public ColorPicketSquare(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ColorPicketSquare(Context context, AttributeSet attrs, int defStyle) {
