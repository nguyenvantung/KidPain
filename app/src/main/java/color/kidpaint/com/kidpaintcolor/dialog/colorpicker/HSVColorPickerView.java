...
package color.kidpaint.com.kidpaintcolor.dialog.colorpicker;
...
import color.kidpaint.com.kidpaintcolor.tools.implementation.BaseTool;
...
public class HSVColorPickerView extends View {
	...
	private void init() {
		...
		Bitmap checkerboard = BitmapFactory.decodeResource(
				AnimalsColoringApplication.applicationContext.getResources(), R.drawable.checkeredbg);
